...
\begin{SCfigure}
\centering
\includegraphics[width=0.5\textwidth]{tauhist1fig2T}
...
Below, we illustrate our procedure under three different exemplary failure time histories;
a more systematic simulation study is subsequently presented in Section~\ref{sec:sim}.
