...
$\E[\Tsysnow]$ must exist, which is a condition for $\fsysnow(t)$ for values of $t$ close to $0$ \citep{2006:coolen-schrijner-coolen}.
...
We will describe next how this approximation is used in \eqref{eq:gtau}.
