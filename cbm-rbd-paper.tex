...
Here we describe how the system reliability function, given fixed component models and the system layout,
...
(The full table would contain $\prod_{k=1}^K (N_k + 1) = 2 \times 2 \times 5 \times 5 = 100$ rows.)
