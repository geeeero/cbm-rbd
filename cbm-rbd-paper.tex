...
as well as the relaibility block diagaram of the system.
...
In this paper, we propose an inspection-based CBM policy
...
the currently used model for system failure times is updated
...
or that this decision should be postponed until the next planned inspection moment,
...
where an operational cycle starts with a new system, and ends after this system has been replaced by a(n as good as) new system. 

In case of a trigger of type (3),
the currently used model for system failure times is updated
like in case of a trigger of type (2)
...
In Section~\ref{sec:literature}, we show our contribution to the CBM literature.
