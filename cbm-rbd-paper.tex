...
As we use a one-cycle criterion, the time these maintenance actions take does not matter for the determination of $\tausnow$.
Downtimes are instead accounted for via the costs parameters,
as described next.
...
use simple system layout, example history of components failing
