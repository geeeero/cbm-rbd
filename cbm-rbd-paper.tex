...
evaluations of $\Rsysnow(\tnow + t)$ and $\fsysnow(\tnow + t)$ only for $t \leq \tau$.
...
(A systematic simulation study is then presented in Section~\ref{sec:sim}.)
...
\begin{figure}
\includegraphics[width=\textwidth]{br1sim1fig5}
...
\label{fig:br1sim1fig5}
\end{figure}

Case 2: failures earlier than expected,
failure times simulated using
$\lambda_k = 0.5 \ykz$ (Figure~\ref{fig:br1sim2fig5}) or
$\lambda_k = 0.2 \ykz$ (Figure~\ref{fig:br1sim4fig5}).

\begin{figure}
\includegraphics[width=\textwidth]{br1sim2fig5}
\caption{***Simulation study, each repetition consists of simulating 5 subsequent operational cycles,
where failure times are simulated as being earlier ($0.5 \times$ MTTF) than expected.}
\label{fig:br1sim2fig5}
\end{figure}

\begin{figure}
\includegraphics[width=\textwidth]{br1sim4fig5}
\caption{***Simulation study, each repetition consists of simulating 5 subsequent operational cycles,
where failure times are simulated as being much earlier ($0.2 \times$ MTTF) than expected.}
\label{fig:br1sim4fig5}
\end{figure}
...
\caption{***Simulation study with ***prsopective costrate criterion***, $\tthresh = 0.5$.
TL: $\lambda_k =     \ykz$,
TR: $\lambda_k = 0.5 \ykz$,
BL: $\lambda_k = 2   \ykz$,
BR: $\lambda_k = 0.2 \ykz$}
...
\caption{***Simulation study with ***total costrate criterion***, $\tthresh = 0.1$ (left) and $\tthresh = 0.2$ (right).}
