...
\caption{$\tausnow$, $t^* = \tnow + \tausnow$, $\gnow(\tausnow)$, and the total cost rate **** as functions of $\tnow$
for the system depicted in Figure~\ref{fig:brakesys-layout},
assuming the failure history $P_2 = 3$, $P_3 = 4$, $C_2 = 6$, $C_3 = 7$, $H = 8$,
and $c_u = 1$, $c_p = 0.2$.
...
up from $0.076$ for repair at time $8.62$, as cost-optimal at time $7.9$.}
