...
failure times simulated using $\lambda_k = 0.5 \ykz$ from Table~\ref{tab:priorparams}.

\begin{figure}
\includegraphics[width=\textwidth]{br1sim2fig5}
\caption{***Simulation study, each repetition consists of simulating 5 subsequent operational cycles,
where failure times are simulated as being earlier than expected.}
...
\caption{***Simulation study, each repetition consists of simulating 5 subsequent operational cycles,
where failure times are simulated as being later than expected.}
\label{fig:br1sim3fig5}
\end{figure}

***do boxplot comparison of all
