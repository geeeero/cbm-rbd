...
\emph{***Hm, yes, currently we have that the system is repaired at $\tnow$ when $\tausnow < \delta$.
...
and would like to apologize for the confusion that the errors may have caused.
